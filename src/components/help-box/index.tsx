...
export const HelpBox: React.FC = () => {
  const ownerRoles: string[] = ['Market Analyst'];
  const customerRoles: string[] = ['Forex Trader'];
  const tenantRoles: string[] = ['Team Member', 'Market Analyst'];
  const addOns: string[] = ['notifications'];
  const applicationName = `FalkForex`;
